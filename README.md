...
### 5 Использование тегов для цитат
Создайте в своей рабочей папке папку для выполнения задания
...
### 7 Использование тегов правки текстов
...
### 8 Вложенные списки и заголовки
...
### 10 Использование тегов форматирования текстов
...
### 25 Динамические эффекты с помощью :hover
...
### 30 Наследование и каскадирование
...
### 34 Задание на размеры, отступы, рамки
...
### 35 Задание на отступы и границы
В своей рабочей папке создайте папку для выполнения задания. Скачайте архив и распакуйте его в созданную папку. 
